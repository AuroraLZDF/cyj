...
function send_mail($tomail, $content, $tilte = '') {
	...
	$mail->SMTPAuth = true; 
	// SMTP 发邮件人的用户名
	$mail->Username = "vip@kxwan.com";   
	 // SMTP 密码
	$mail->Password = "wq7564653";
	
	$mail->From = "vip@kxwan.com";
	
	
	$mail->FromName = "=?utf-8?B?" . base64_encode("开心玩用户中心<vip@kxwan.com>") . "?=";
	$mail->AddAddress($tomail);
	
	$mail->AddReplyTo("vip@kxwan.com","kxwan.com");
...
function send_promoter_mail($tomail, $content, $tilte = '', $fromName="") {
	...
	$mail->SMTPAuth = true; 
	// SMTP 发邮件人的用户名
	$mail->Username = "web@vip.leshu.com";   
	 // SMTP 密码
	$mail->Password = "leshu520"; 
	$mail->From = "web@vip.leshu.com";
	$mail->FromName = "=?utf-8?B?" . base64_encode($fromName) . "?=";
	$mail->AddAddress($tomail);
	$mail->AddReplyTo("web@vip.leshu.com","leshu.com");
	$mail->WordWrap = 1000;            
	$mail->IsHTML(true);  
	$mail->CharSet="utf-8";
	$mail->Encoding = "base64";	
