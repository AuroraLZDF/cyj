...
class Ftp
{
     ...
     * @return bool
     */
    public function get_file($localName, $serverPath, $homePath)
    {
        $localPath = $localName ? $homePath . $localName : $homePath . "tmp.dat";
        $this->off = ftp_get($this->conn_id, $localPath, $serverPath, FTP_BINARY);// 下载
