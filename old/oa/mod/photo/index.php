...
class index extends AdModel{
    ...
    /*public function indexBefore(&$datas){
        foreach($datas as $key => $item){
            $datas[$key]['images'] = json_decode($item, 1);
        }
    }*/
    ...
    public function field_images($v, $param){
        $GLOBALS['tpl']->assign('images', json_decode($v, 1));
        $GLOBALS['tpl']->assign('param', $param);
        $GLOBALS['tpl']->display('filter/photo/field_images.tpl');
    }
}
